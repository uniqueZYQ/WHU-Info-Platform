...
public class BToast extends Toast {
     ...
     * Toast单例
     */
    private static com.example.whuinfoplatform.Entity.BToast toast;
    ...
    private static void initToast(Context context, CharSequence text) {
        try {
            ...
            toast = new com.example.whuinfoplatform.Entity.BToast(context);
    ...
    public static void showToast(Context context, CharSequence text, int time, int imgType) {
        ...
        if (imgType == TYPE_HIDE) {
            ...
            if (imgType == TYPE_TRUE) {
                ...
                toast_img.setBackgroundResource(R.drawable.toast_l);
                // 动画
                ObjectAnimator.ofFloat(toast_img, "rotation", 0, 360).setDuration(1700).start();
            }
        }
