    ...
    OnGetPoiSearchResultListener listener1 = new OnGetPoiSearchResultListener() {
        ...
        public void onGetPoiResult(PoiResult poiResult) {
            if(poiResult.getTotalPoiNum()>=5){
                ...
                //搜索结果为空
                BToast.showText(Renew_Info_promote_Activity.this,"暂无该地点\n试试其他搜索关键词!",false);
                mBaiduMap.clear();
            }
        }
        @Override
            ...
            if(size>0){
                ...
                button2.setOnClickListener(v -> {
                    if(i<size){
                        ...
                        BToast.showText(Renew_Info_promote_Activity.this,"没有更多结果了\n试试搜索其他关键词!",false);
                });
            }
        }
        @Override
                ...
                case 1:{
                    ...
                    binding.finish.setOnClickListener(v->{
                        ...
                        if(reward==-1||reward==0)
                            ...
                            BToast.showText(Renew_Info_promote_Activity.this,"请完善信息",false);
                    });
                    break;
                }
                case 2:{
        ...
        binding.input.setOnEditorActionListener((v, actionId, event) -> {
            if(actionId== EditorInfo.IME_ACTION_SEARCH){
                ...
                if(valid){
                    ...
                    BToast.showText(Renew_Info_promote_Activity.this,"无法搜索无实义的内容！",false);
                }
                return true;
            }
            else
